...
class   WebServiceAdapter(internal var context: Context, private val pokemonList: List<Pokemon>, private val pokemonClickListener: (Pokemon) -> Unit) :
    RecyclerView.Adapter<WebServiceAdapter.WebServicesViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        LayoutInflater.from(parent.context).inflate(R.layout.activity_web_services_cell, parent, false)
    )
    ...
    override fun onBindViewHolder(holder: WebServicesViewHolder, position: Int) {
        ...
        val num = nf.format(pokemonList[position].num)
